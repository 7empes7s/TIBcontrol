...
export type BuilderWorkflowConfig = {
  ...
  riskPolicy: {
    ...
    maxPasses: number;
    /** Hard ceiling on a pass (default 7200). Raise, don't lower — stall detection handles hung agents. */
    passTimeoutSeconds?: number;
    /** Kill if no stdout/stderr output for this many seconds (default 600). */
    stallTimeoutSeconds?: number;
    /** When true, a timed-out pass (exit 124) automatically starts the next pass with continuation context. */
