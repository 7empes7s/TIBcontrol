...
import { AgentRuntimeBar, type ApprovalMode, type OutputFormat } from "../components/AgentRuntimeBar";
      ...
      <main className="oc-main">
        ...
        {active && (
          <AgentRuntimeBar
            ...
            onModelChange={(m) => setRuntimeOptions((o) => ({ ...o, model: m }))}
            models={geminiModels}
            approvalMode={runtimeOptions.approvalMode}
            onApprovalModeChange={(m) => setRuntimeOptions((o) => ({ ...o, approvalMode: m }))}
            outputFormat={runtimeOptions.outputFormat}
            onOutputFormatChange={(f) => setRuntimeOptions((o) => ({ ...o, outputFormat: f }))}
            yoloWarn
          />
        )}
